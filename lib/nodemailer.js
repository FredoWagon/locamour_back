...
Voici le lien https://fred-et-barbara.com/?page=${data._id} \n
...
const certificateMail = async (res, object) => {
  try {
    const data = object.data.annonce
    let transporter;
    console.log("dans le if");
    ...
    const mailData = {
      from: "fedde.leg@gmail.com",  // sender address
      to: `${data.contactEmail} `,   // list of receivers
      subject: "Fred & Barbara : Notre dossier locatif",
      text: `Bonjour ! \n
Notre dossier locatif est désormais accéssible au téléchargement
au format pdf en bas de notre page internet. \n
Voici le lien https://fred-et-barbara.com/?page=${data._id} \n
 En attendant d'avoir de vos nouvelles,
 nous vous souhaitons une belle journée ! \n
 Fred & Barbara`
...
module.exports = { mail, certificateMail };
